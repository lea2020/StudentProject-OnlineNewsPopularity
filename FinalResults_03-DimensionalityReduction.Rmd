...
Some of the top predictors in terms of Mean Decrease in Accuracy include maximum shares of the average keyword, minimum shares of referenced articles in Mashable, minimum shares of the average keyword, closeness to LDA topic 2, closeness to LDA topic 0, whether the article was published on Saturday, closeness to LDA topic 4, whether the data channel is Entertainment, whether the data channel is Social Media, and closeness to LDA topic 1.
...
Some of the top predictors in terms of Mean Decrease in Gini include maximum shares of the average keyword, minimum shares of referenced articles in Mashable, closeness to LDA topic 2, average shares of the best keyword, closeness to LDA topic 1, rate of unique non-stop words in the content,  closeness to LDA topic 4, closeness to LDA topic 0, text subjectivity, and maximum shares of the worst keyword.
