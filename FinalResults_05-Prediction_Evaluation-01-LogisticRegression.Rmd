...
Most of the estimates are statistically significant and the model produces the following relationship between the log odds of popularity and the predictors (i.e.
the independent variables that have a significant effect on the dependent variable):

logit(p) = 601.45 + 7.81(maximum shares of average keyword) + 6.38(minimum shares of referenced articles in                    
           Mashable) - 557.22(closeness to LDA topic 0) + 0.42(minimum shares of the average keyword)
